...
def create_plots(trainers: List[Trainer], names: List[str]):
    ...
    for trainer, name in zip(trainers, names):
        ...
        plt.legend()
    plt.savefig(plot_path.joinpath(f"task_3_plot.png"))
    plt.show()
...
def main():
    ...
    create_plots([trainer, example_trainer], ["task3", "task3_default"])
