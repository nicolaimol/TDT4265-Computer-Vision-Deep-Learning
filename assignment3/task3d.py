...
def main():
    ...
    example_model = Task3_uten(image_channels=3, num_classes=10)
    ...
    create_plots([trainer, example_trainer], ["task3", "task3_default"], "task3_plot_3d.png")
